...
| 2 | [ADR-002](adr/ADR-002-auth-guard.md) | Hook `useAuthGuard` | Crítica | Pendiente | ADR-003 |
| 3 | [ADR-003](adr/ADR-003-typescript-types.md) | Tipos TypeScript globales | Alta | Pendiente | — |
