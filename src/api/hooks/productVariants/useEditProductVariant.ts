// SWR-based mutation hook for updating an existing product variant (PUT /api/product-variants/[id]).
//
...
// Reuses CreateVariantReq — the editable fields are the same as the create fields.
...
// payload.data: updated variant fields (same shape as CreateVariantReq).
